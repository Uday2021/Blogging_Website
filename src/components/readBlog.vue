      ...
      <div class="cs-blog-detail">
        ...
        <div class="cs-post-title">
          <div class="cs-author">
            <figure>
              <a
                href="http://jobcareer.chimpgroup.com/jobdoor/user/jobcareer-admin/"
                ><img
                  width="32"
                  height="32"
                  onload="pagespeed.CriticalImages.checkImageForCriticality(this);"
                  ...
                  srcset="
                    http://1.gravatar.com/avatar/7a20fad302fc2dd4b4649dc5bdb3c463?s=64&amp;d=mm&amp;r=g 2x
                  "
          ...
          <div class="post-option">
            <span class="post-date"
              ><a href="http://jobcareer.chimpgroup.com/jobdoor/2015/11/"
                ><i class="cs-color icon-calendar6"></i
                >{{ bdetail.createdDate }}</a
              ></span
            >
            <span class="post-comment"
              ><a
                href="http://jobcareer.chimpgroup.com/jobdoor/experience-writing-for-producing-a-newscast/#comments"
                ><i class="cs-color icon-chat6"></i>4 Comments</a
              ></span
            >
          </div>
        </div>
        <div class="cs-post-option-panel">
          <div v-html="bdetail.description" class="rich-editor-text"></div>
        </div>
        <div class="cs-tags">
          <div class="tags">
            <span>Tags</span>
...
export default {
  ...
  mounted(){
        ...
        axios
      .get(
        `http://localhost:3001/blogs/${this.id}`
      )
      .then((res) => {
          console.log(res.data.data.blog);
          this.bdetail = res.data.data.blog;
          this.bdetail.createdDate = moment(res.data.data.blog.createdDate).format('MMMM Do YYYY, h:mm:ss a');
